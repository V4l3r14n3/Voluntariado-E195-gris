...
> Backend real con **Supabase**: autenticación, base de datos PostgreSQL y almacenamiento de archivos.
...
El proyecto cuenta con backend real sobre Supabase:
...
│   │   │   └── auth-context.tsx    # usa Supabase Auth
...
| Rol              | Descripción                              | Origen                                | Accesos principales                                   |
| ---------------- | ----------------------------------------- | -------------------------------------- | ------------------------------------------------------- |
| 👑 **admin**         | Administra organizaciones y plataforma | Asignado manualmente en `profiles`    | Dashboard, Organizaciones, Foro, Perfil                |
| 🏢 **organization**  | Publica oportunidades de voluntariado  | Registro vía flujo de organización    | Dashboard, Oportunidades, Foro, Blog, Reportes, Perfil |
| 🙋 **volunteer**     | Busca y se postula a oportunidades     | Registro estándar                     | Dashboard, Buscar, Foro, Blog, Mis reportes, Perfil    |
